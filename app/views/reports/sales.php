...
<div class="row g-3 mb-3">
    ...
    <div class="col-md-3"><div class="card shadow-sm"><div class="card-body">
        <div class="text-muted small">Total Penjualan</div><div class="fs-5 fw-bold"><?= format_rupiah($summary['total_penjualan']) ?></div>
    </div></div></div>
    <div class="col-md-3"><div class="card shadow-sm"><div class="card-body">
        <div class="text-muted small">Total Diskon</div><div class="fs-5 fw-bold"><?= format_rupiah($summary['total_diskon']) ?></div>
    </div></div></div>
    <div class="col-md-3"><div class="card shadow-sm"><div class="card-body">
        <div class="text-muted small">Total Pajak</div><div class="fs-5 fw-bold"><?= format_rupiah($summary['total_pajak']) ?></div>
    </div></div></div>
</div>
...
<div class="card shadow-sm">
    <div class="card-body">
        <table class="table table-sm table-hover">
            <thead><tr><th>Invoice</th><th>Tanggal</th><th>Kasir</th><th>Pelanggan</th><th class="text-end">Subtotal</th><th class="text-end">Diskon</th><th class="text-end">Pajak</th><th class="text-end">Grand Total</th></tr></thead>
            <tbody>
                <?php if (empty($detail)): ?>
                ...
                <?php foreach ($detail as $r): ?>
                    <tr>
                        ...
                        <td><?= format_tanggal($r['sale_date']) ?></td>
                        <td><?= e($r['cashier_name']) ?></td>
                        <td><?= e($r['customer_name'] ?? '-') ?></td>
                        <td class="text-end"><?= format_rupiah($r['subtotal']) ?></td>
                        <td class="text-end"><?= format_rupiah($r['discount_total']) ?></td>
