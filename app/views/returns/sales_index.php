...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <?php if (user_can('returns.index', 'create')): ?>
        <a href="<?= url('/returns/sales/create') ?>" class="btn btn-primary btn-sm">+ Retur Penjualan Baru</a>
    <?php endif; ?>
</div>

<div class="card shadow-sm">
    <div class="card-body">
        <h6 class="card-title">Daftar Retur Penjualan</h6>
        <table class="table table-hover align-middle">
            ...
            <tbody>
                <?php if (empty($returns)): ?>
                    <tr><td colspan="7" class="text-center text-muted py-4">Belum ada retur penjualan.</td></tr>
                <?php endif; ?>
                <?php foreach ($returns as $r): ?>
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="<?= url('/returns/sales/' . $r['id']) ?>" class="btn btn-sm btn-outline-primary">Detail</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
