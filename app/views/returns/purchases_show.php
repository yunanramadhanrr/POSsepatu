    ...
    <div class="card-body">
        <div class="d-flex justify-content-between mb-3">
            <div>
                ...
                <p class="mb-0"><strong>Invoice Pembelian:</strong> <?= e($return['invoice_number']) ?></p>
                <p class="mb-0"><strong>Tanggal:</strong> <?= format_tanggal($return['return_date'], 'd-m-Y') ?></p>
            </div>
            <div class="text-end">
                <p class="mb-0"><strong>Supplier:</strong> <?= e($return['supplier_name']) ?></p>
        ...
        <div class="row justify-content-end">
            <div class="col-md-4">
                <div class="d-flex justify-content-between fw-bold fs-5">
                    <span>Total</span><span><?= format_rupiah($return['total']) ?></span>
                </div>
            </div>
        </div>
